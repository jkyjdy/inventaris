                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" name="unit" required>
                                                ...
                                                <option value="Komite Etik">Komite Etik</option>
                                                <option value="Panitia Farmasi">Panitia Farmasi</option>
                                                <option value="Panitia K3RS">Panitia K3RS</option>
                                                <option value="Panitia Rekam Medis">Panitia Rekam Medis</option>
                                                <option value="Komite Akreditasi">Komite Akreditasi</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            Tgl Pengadaan
