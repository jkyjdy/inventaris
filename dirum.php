                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-primary text-white">
                            ...
                            <div class="card-body" style="background:Slate Blue">
                                <form action="koneksi/tambahdirum.php"method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                        No Urut 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <option value="">--Pilih--</option>
                                            <option value="Pemeliharaan & Sarana">Pemeliharaan & Sarana </option>
                                            <option value="Utility">Utility </option>
                                            <option value="Kendaraan">Kendaraan </option>
                                            <option value="Keamanan">Keamanan </option>
                                            <option value="Kebersihan & Pertamanan">Kebersihan & Pertamanan </option>
                                            <option value="sanitasi"> Sanitasi </option>
                                            <option value="Pengadaan & Pemeliharaan Linen">Pengadaan & Pemeliharaan Linen </option>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <form action="cetak_laporan3.php" target="_blank" method="POST">
                        ...
                        <div class="card-body">
                        <form action="dirum.php" method="POST">
                            <?php
                            include 'koneksi/koneksi.php';
                            $data1=mysqli_query($koneksi, "select count(jenis_barang) from dirum where unit='".$_POST['unit']."' and jenis_barang='".$_POST['jenis_barang']."'");
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="unit" >
                                        <option>--Pilih--</option>
                                        <option value ="Pemeliharaan & Sarana" <?php if($_POST['unit']=="Pemeliharaan & Sarana"){ echo"selected";} ?>>Pemeliharaan & Sarana</option>
                                        <option value ="Utility" <?php if($_POST['unit']=="Utility"){ echo"selected";} ?>>Utility</option>
                                        <option value ="Kendaraan" <?php if($_POST['unit']=="Kendaraan"){ echo"selected";} ?>>Kendaraan</option>
                                        <option value ="Keamanan" <?php if($_POST['unit']=="Keamanan"){ echo"selected";} ?>>Keamanan</option>
                                        <option value ="Kebersihan & Pertamanan" <?php if($_POST['unit']=="Kebersihan & Pertamanan"){ echo"selected";} ?>>Kebersihan & Pertamanan</option>
                                        <option value ="Sanitasi" <?php if($_POST['unit']=="Sanitasi"){ echo"selected";} ?>>Sanitasi</option>
                                        <option value ="Pengadaan & Pemeliharaan Linen" <?php if($_POST['unit']=="Pengadaan & Pemeliharaan Linen"){ echo"selected";} ?>>Pengadaan & Pemeliharaan Linen</option>
                                        <option value ="SIRS" <?php if($_POST['unit']=="SIRS"){ echo"selected";} ?>>SIRS</option>
                                        <option value ="Humas" <?php if($_POST['unit']=="Humas"){ echo"selected";} ?>>Humas</option> 
                                        <option value ="Sekretariat" <?php if($_POST['unit']=="Sekretariat"){ echo"selected";} ?>>Sekretariat</option>
                                    </select>
                                ...
                                <table class="table table-bordered" id="dataTable" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Harga</th>
                                            <?php
                                                if(($_SESSION['role']=="administrator") or ($_SESSION['role']=="direktorat umum")){
                                            ?>
                                    ...
                                    if (($_POST['unit']!="")&&($_POST['jenis_barang']!="")) {
                                        ...
                                        $data=mysqli_query($koneksi,"select * from dirum where unit = '$unit' and jenis_barang = '$jenis_barang'");
                                    }else{
                                    ...
                                    while($isi=mysqli_fetch_array($data)){
                                        ...
                                        <tr>
                                            ...
                                            <form action="koneksi/tambah3.php"method="POST">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                            ...
                                            ?>
                                            <td >
                                                <a href="editdirum.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-primary"  style="float:left"><i class="fa fa-file"></i></a> 
                                                <a href="koneksi/hapusdirum.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-danger" style="float:right"><i class="fa fa-eraser"></i></a>
                                                <br>
                                                <br>
                                                <a href="cetak_dirum.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-warning"  style="float:left"><i class="fa fa-print"></i></a>
