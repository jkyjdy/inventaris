...
mysqli_query($koneksi,"insert into permintaan (ID,no_inventaris,direktorat,unit,merk,inputer,jenis_barang,kerusakan,status,tgl_mulai,waktu_mulai) values('','$no_inventaris','$direktorat','$unit','$merk','$inputer','$jenis_barang','$kerusakan','$status','$tgl_mulai','$waktu_mulai')");
