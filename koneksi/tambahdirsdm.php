...
$data=mysqli_query($koneksi, "select * from dirsdm where no_inventaris = '$no_inventaris/$jenis_barang_new/$unit_new/$sub_tgl_pengadaan/$tahun_operasional'") or die (mysqli_error());
$isi=mysqli_fetch_array($data);
...
mysqli_query($koneksi,"insert into dirsdm values('','$no_inventaris/$jenis_barang_new/$unit_new/$sub_tgl_pengadaan/$tahun_operasional','$unit','$tgl_pengadaan','$tahun_operasional','$jenis_barang','$merk','$lokasi','$kondisi','$harga','$status','$no_seri','$type' '')");
