            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
						...
						$ID = $_GET['ID'];
						$data = mysqli_query($koneksi,"select * from dirrawat where ID='$ID'");
						while($isi=mysqli_fetch_array($data)){
                            ...
                            <div class="card-body" style="background:Slate Blue">
                                <form action="koneksi/updaterawat.php"method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                        No Urut 
                                        <?php
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="unit" value="<?php echo $isi['unit']; ?>"> 
                                            <option>--Pilih--</option>
                                            <option value ="Maria" <?php if($isi['unit']=="Maria"){ echo"selected";} ?>>Maria</option>
                                            <option value ="Anna / VK" <?php if($isi['unit']=="Anna / VK"){ echo"selected";} ?>>Anna / VK</option>
                                            <option value ="MD" <?php if($isi['unit']=="MD"){ echo"selected";} ?>>MD</option>
                                            <option value ="Theresia" <?php if($isi['unit']=="Theresia"){ echo"selected";} ?>>Theresia</option>
                                            <option value ="Yoseph" <?php if($isi['unit']=="Yoseph"){ echo"selected";} ?>>Yoseph</option>
                                            <option value ="Pastoral Care" <?php if($isi['unit']=="Pastoral Care"){ echo"selected";} ?>>Pastoral Care</option>
                                        </select>            
                                    </div>
                                    <div class="col-md-4">
                                        Jenis Barang 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4"><br>
										...
										<a href="dirrawat.php"><button type="button" class="btn btn-warning" data-dismiss="modal" name="kembali">Kembali</button></a>
                                    </div>
                                </div>
                                </form>
                            </div> 
                                ...
                                <table class="table table-bordered" id="dataTable" cellspacing="0">
                                    ...
                                    while($isi =mysqli_fetch_array($data)){
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <a href="editrawat.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-primary"  style="float:left"><i class="fas fa-file"></i></a> 
                                                <a href="koneksi/hapusrawat.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-danger" style="float:right"><i class="fas fa-eraser"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
