            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
						...
						$ID = $_GET['ID'];
						$data = mysqli_query($koneksi,"select * from komite where ID='$ID'");
						while($isi=mysqli_fetch_array($data)){
                            ...
                            <div class="card-body" style="background:Slate Blue">
                                <form action="koneksi/updatekomite.php"method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                        No Urut 
                                        <?php
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="unit" value="<?php echo $isi['unit']; ?>"> 
                                            <option>--Pilih--</option>
                                            <option value ="Medis" <?php if($isi['unit']=="Medis"){ echo"selected";} ?>>Medis</option>
                                            <option value ="Keperawatan" <?php if($isi['unit']=="Keperawatan"){ echo"selected";} ?>>Keperawatan</option>
                                            <option value ="PMKP" <?php if($isi['unit']=="PMKP"){ echo"selected";} ?>>PMKP</option>
                                            <option value ="PPI" <?php if($isi['unit']=="PPI"){ echo"selected";} ?>>PPI</option>
                                            <option value ="Etik" <?php if($isi['unit']=="Etik"){ echo"selected";} ?>>Etik</option>
                                            <option value ="Farmasi" <?php if($isi['unit']=="Farmasi"){ echo"selected";} ?>>Farmasi</option>
                                            <option value ="K3RS" <?php if($isi['unit']=="K3RS"){ echo"selected";} ?>>K3RS</option>
                                            <option value ="Rekam Medis" <?php if($isi['unit']=="Rekam Medis"){ echo"selected";} ?>>Rekam Medis</option>
                                            <option value ="Akreditasi" <?php if($isi['unit']=="Akreditasi"){ echo"selected";} ?>>Akreditasi</option>
                                        </select>             
                                    </div>
                                    <div class="col-md-4">
                                        Jenis Barang 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4"><br>
										...
										<a href="komite.php"><button type="button" class="btn btn-warning" data-dismiss="modal" name="kembali">Kembali</button></a>
                                    </div>
                                </div>
                                </form>
                            </div> 
                                ...
                                <table class="table table-bordered" id="dataTable" cellspacing="0">
                                    ...
                                    while($isi =mysqli_fetch_array($data)){
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <a href="editkomite.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-primary"  style="float:left"><i class="fas fa-file"></i></a> 
                                                <a href="koneksi/hapuskomite.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-danger" style="float:right"><i class="fas fa-eraser"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
