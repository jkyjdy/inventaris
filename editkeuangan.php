            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
						...
						$ID = $_GET['ID'];
						$data = mysqli_query($koneksi,"select * from dir_keuangan where ID='$ID'");
						while($isi=mysqli_fetch_array($data)){
                            ...
                            <div class="card-body" style="background:Slate Blue">
                                <form action="koneksi/updatekeuangan.php"method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                        No Urut 
                                        <?php
                                        ...
                                        <input type="number" name= "no_inventaris" value = "<?php echo $sub_no_inventaris ?>" class="form-control">
                                    </div>
                                    <div class="col-md-4">
                                        No Seri
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="unit" value="<?php echo $isi['unit']; ?>"> 
                                            <option>--Pilih--</option>
                                            <option value ="Akuntansi & Piutang" <?php if($isi['unit']=="Akuntansi & Piutang"){ echo"selected";} ?>>Akuntansi & Piutang</option>
                                            <option value ="Keuangan" <?php if($isi['unit']=="Keuangan"){ echo"selected";} ?>>Keuangan</option>
                                            <option value ="Billing & Penerimaan" <?php if($isi['unit']=="Billing & Penerimaan"){ echo"selected";} ?>>Billing & Penerimaan</option>
                                            <option value ="Pengeluaran" <?php if($isi['unit']=="Pengeluaran"){ echo"selected";} ?>>Pengeluaran</option>
                                            <option value ="Asuransi Center" <?php if($isi['unit']=="Asuransi Center"){ echo"selected";} ?>>Asuransi Center</option>
                                            <option value ="Logistik" <?php if($isi['unit']=="Logistik"){ echo"selected";} ?>>Logistik</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4"><br>
										...
										<a href="dir_keuangan.php"><button type="button" class="btn btn-warning" data-dismiss="modal" name="kembali">Kembali</button></a>
                                    </div>
                                </div>
                                </form>
                            </div> 
                                ...
                                <table class="table table-bordered" id="dataTable" cellspacing="0">
                                    ...
                                    while($isi =mysqli_fetch_array($data)){
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <a href="editkeuangan.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-primary"  style="float:left"><i class="fas fa-file"></i></a> 
                                                <a href="koneksi/hapuskeuangan.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-danger" style="float:right"><i class="fas fa-eraser"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
