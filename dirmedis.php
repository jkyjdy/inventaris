                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-primary text-white">
                            ...
                            <div class="card-body" style="background:Slate Blue">
                                <form action="koneksi/tambahdirmedis.php"method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                        No Urut 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="unit" required>
                                            ...
                                            <option value="Haemodialisa">Haemodialisa</option>
                                            <option value="PKRS">PKRS</option>
                                            <option value="Bidang Penunjang Medis">Bidang Penunjang Medis</option>
                                            <option value="Laboratorium">Laboratorium</option>
                                            <option value="Radiologi">Radiologi</option>
                                            <option value="Farmasi">Farmasi</option>
                                            <option value="Rekam Medis">Rekam Medis</option>
                                            <option value="Fisio Terapi">Fisio Terapi</option>
                                            <option value="Tempat Pendaftaran Pasien">Tempat Pendaftaran Pasien</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4"><br>
                                        ...
                                        <!-- <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#label">
                                        Cetak Label
                                        </button> -->
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <select class="form-control" name="unit" required>
                                                    ...
                                                    <option value="Fisio Terapi">Fisio Terapi</option>
                                                    <option value="Tempat Pendaftaran Pasien">Tempat Pendaftaran Pasien</option>
                                                    <option value="Bagian Gizi">Bagian Gizi</option>
                            ...
                            <form action="cetak_label.php" target="_blank" method="POST">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                            <input type="submit" value="Mencetak" class="btn btn-warning">
                                            <!-- <a href="cetak_laporan.php" target="_blank" class="btn btn-warning">Cetak</a> -->
                                        </div>
                                        </form>
                                        </div>
                        ...
                        <div class="card-body">
                            <form action="dirmedis.php" method="POST">
                            <?php
                            include 'koneksi/koneksi.php';
                            $data1=mysqli_query($koneksi, "select count(jenis_barang) from dir_medis where unit='".$_POST['unit']."' and jenis_barang='".$_POST['jenis_barang']."'");
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="unit" > 
                                        <option>--Pilih--</option>
                                        <option value ="IGD" <?php if($_POST['unit']=="IGD"){ echo"selected";} ?>>IGD</option>
                                        <option value ="PONEK" <?php if($_POST['unit']=="PONEK"){ echo"selected";} ?>>PONEK</option>
                                        <option value ="IBS" <?php if($_POST['unit']=="IBS"){ echo"selected";} ?>>IBS</option>
                                        <option value ="ICU" <?php if($_POST['unit']=="ICU"){ echo"selected";} ?>>ICU</option>
                                        <option value ="Poliklinik" <?php if($_POST['unit']=="Poliklinik"){ echo"selected";} ?>>Poliklinik</option>
                                        <option value ="Haemodialisa" <?php if($_POST['unit']=="Haemodialisa"){ echo"selected";} ?>>Haemodialisa</option>
                                        <option value ="PKRS" <?php if($_POST['unit']=="PKRS"){ echo"selected";} ?>>PKRS</option>
                                        <option value ="Bidang Penunjang Medis" <?php if($_POST['unit']=="Bidang Penunjang Medis"){ echo"selected";} ?>>Bidang Penunjang Medis</option>
                                        <option value ="Laboratorium" <?php if($_POST['unit']=="Laboratorium"){ echo"selected";} ?>>Laboratorium</option>
                                        <option value ="Radiologi" <?php if($_POST['unit']=="Radiologi"){ echo"selected";} ?>>Radiologi</option>
                                        ...
                                        <option value ="Fisioterapi" <?php if($_POST['unit']=="Fisioterapi"){ echo"selected";} ?>>Fisioterapi</option>
                                        <option value ="Tempat Pendaftaran Pasien" <?php if($_POST['unit']=="Tempat Pendaftaran Pasien"){ echo"selected";} ?>>Tempat Pendaftaran Pasien</option>
                                        <option value ="Gizi" <?php if($_POST['unit']=="Gizi"){ echo"selected";} ?>>Gizi</option>
                                    </select>
                                ...
                                <table class="table table-bordered" id="dataTable" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Harga</th>
                                            <?php 
                                            // jika login dengan role adminisrator maka lakukan aksi.
                                                if (($_SESSION['role']=="administrator")  or ($_SESSION['role']=="direktorat medis")){
                                            ?>
                                            <th width="180">Lakukan_Aksi</th>
                                            <?php
                                                }
                                            ?>
                                        </tr>
                                    ...
                                    if (($_POST['unit']!="")&&($_POST['jenis_barang']!="")) {
                                        ...
                                        $data=mysqli_query($koneksi,"select * from dir_medis where unit = '$unit' and jenis_barang = '$jenis_barang'");
                                    }else{
                                        $data=mysqli_query($koneksi,"select * from dir_medis order by ID desc");
                                    }
                                    ...
                                    while($isi =mysqli_fetch_array($data)){
                                        ...
                                        <tr>
                                            ...
                                            <form action="koneksi/tambah1.php"method="POST">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                            ...
                                            ?>
                                            <td >
                                                <a href="edit.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-primary"  style="float:left"><i class="fa fa-file"></i></a> 
                                                <a href="koneksi/hapus.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-danger" style="float:right"><i class="fa fa-eraser"></i></a>
                                                <br>
                                                <br>
                                                <a href="cetak_label.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-warning"  style="float:left"><i class="fa fa-print"></i></a>
