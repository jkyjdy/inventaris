            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
						...
						$ID = $_GET['ID'];
						$data = mysqli_query($koneksi,"select * from lain where ID='$ID'");
						while($isi=mysqli_fetch_array($data)){
                            ...
                            <div class="card-body" style="background:Slate Blue">
                                <form action="koneksi/updatelain.php"method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                        No Urut 
                                        <?php
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="unit" value="<?php echo $isi['unit']; ?>"> 
                                            <option>--Pilih--</option>
                                            <option value ="ASPI" <?php if($isi['unit']=="ASPI"){ echo"selected";} ?>>ASPI</option>
                                            <option value ="ASISI" <?php if($isi['unit']=="ASISI"){ echo"selected";} ?>>ASISI</option>
                                        </select>            
                                    </div>
                                    <div class="col-md-4">
                                        Jenis Barang 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4"><br>
										...
										<a href="lain.php"><button type="button" class="btn btn-warning" data-dismiss="modal" name="kembali">Kembali</button></a>
                                    </div>
                                </div>
                                </form>
                            </div> 
                                ...
                                <table class="table table-bordered" id="dataTable" cellspacing="0">
                                    ...
                                    while($isi =mysqli_fetch_array($data)){
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <a href="editlain.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-primary"  style="float:left"><i class="fas fa-file"></i></a> 
                                                <a href="koneksi/hapuslain.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-danger" style="float:right"><i class="fas fa-eraser"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
