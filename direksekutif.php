            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- ------------------------ MEMASUKKAN JUDUL --------------------------------- -->
                        <h1 class="h3 mb-0 text-gray-800">Direktorat Eksekutif</h1>
                    </div>
                    ...
                    <div class="card show mb-4">
                        <div class="card-header bg-primary text-white">
                            ...
                            <div calss="card-body" style="background:Slate Blue">
                                <form action="koneksi/tambahdireksekutif.php" method="POST">  
                                <div class="row">
                                    <div class="col-md-4">
                                        No Urut
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <form action="cetak_laporan6.php" target="_blank" method="POST">
                        ...
                        <div class="card-body">
                        <form action="direksekutif.php" method="POST">
                            <?php
                            include 'koneksi/koneksi.php';
                            $data1=mysqli_query($koneksi, "select count(jenis_barang) from direksekutif where unit='".$_POST['unit']."' and jenis_barang='".$_POST['jenis_barang']."'");
                                ...
                                <table class="table table-bordered" id="dataTable" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Harga</th>
                                            <?php
                                                if(($_SESSION['role']=="administrator") or ($_SESSION['role']=="direktorat eksekutif")){
                                            ?>
                                    ...
                                    if (($_POST['unit']!="")&&($_POST['jenis_barang']!="")) {
                                        ...
                                        $data=mysqli_query($koneksi,"select * from direksekutif where unit = '$unit' and jenis_barang = '$jenis_barang'");
                                    }else{
                                        $data=mysqli_query($koneksi,"select * from direksekutif order by ID desc");
                                    }
                                    while($isi=mysqli_fetch_array($data)){
                                        ...
                                        <tr>
                                            ...
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#permintaan<?php echo $isi['ID'];?>">
                                           Maintenance
                                            </button>

                                            <!-- Modal -->
                                            <div class="modal fade" id="permintaan<?php echo $isi['ID'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <form action="koneksi/tambah6.php"method="POST">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                            ...
                                            ?>
                                            <td>
                                                <a href="editeksekutif.php?ID=<?php echo $isi['ID']; ?>" class="btn btn-primary" style="float:left"><i class="fa fa-file"></i></a>
                                                <a href="koneksi/hapuseksekutif.php?ID=<?php echo $isi['ID']; ?>" class="btn btn-danger" style="float:right"><i class="fa fa-eraser"></i></a>
                                                <br>
                                                <br>
                                                <a href="cetak_eksekutif.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-warning"  style="float:left"><i class="fa fa-print"></i></a>
