            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- ------------------------ MEMASUKKAN JUDUL --------------------------------- -->
                        <h1 class="h3 mb-0 text-gray-800">Lain-Lain</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-primary text-white">
                            ...
                            <div class="card-body" style="background:Slate Blue">
                                <form action="koneksi/tambahlain.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-4">
                                            No Urut
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="unit" required>
                                            ...
                                            <option value="ASPI">ASPI</opion>
                                            <option value="ASISI">ASISI</opion>
                                        <select>
                                    </div>
                                    <div class="col-md-4">
                                        Jenis Barang 
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <form action="cetak_laporan8.php" target="_blank" method="POST">
                        ...
                        <div class="card-body">
                        <form action="lain.php" method="POST">
                            <?php
                            include 'koneksi/koneksi.php';
                            $data1=mysqli_query($koneksi, "select count(jenis_barang) from lain where unit='".$_POST['unit']."' and jenis_barang='".$_POST['jenis_barang']."'");
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="unit" > 
                                        <option>--Pilih--</option>
                                        <option value ="ASPI" <?php if($_POST['unit']=="ASPI"){ echo"selected";} ?>>ASPI</option>
                                    </select> 
                                ...
                                <table class="table table-bordered" id="dataTable" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Harga</th>
                                            <?php
                                                if(($_SESSION['role']=="administrator")  or ($_SESSION['role']=="lain")){
                                            ?>
                                    ...
                                    if (($_POST['unit']!="")&&($_POST['jenis_barang']!="")) {
                                        ...
                                        $data=mysqli_query($koneksi,"select * from lain where unit = '$unit' and jenis_barang = '$jenis_barang'");
                                    }else{
                                        $data=mysqli_query($koneksi,"select * from lain order by ID desc");
                                    }
                                    while($isi=mysqli_fetch_array($data)){
                                        ...
                                        <tr>
                                            ...
                                            <form action="koneksi/tambah8.php"method="POST">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                            ...
                                            ?>
                                            <td>
                                                <a href="editlain.php?ID=<?php echo $isi['ID']; ?>" class="btn btn-primary" style="float:left"><i class="fa fa-file"></i></a>
                                                <a href="koneksi/hapuslain.php?ID=<?php echo $isi['ID']; ?>" class="btn btn-danger" style="float:right"><i class="fa fa-eraser"></i></a>
                                                <br>
                                                <br>
                                                <a href="cetak_lain.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-warning"  style="float:left"><i class="fa fa-print"></i></a>
