            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- ------------------------ MEMASUKKAN JUDUL --------------------------------- -->
                        <h1 class="h3 mb-0 text-gray-800">Direktorat Keperawatan</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-primary text-white">
                            ...
                            <div class="card-body" style="background:Slate Blue">
                                <form action="koneksi/tambahdirrawat.php"method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                        No Urut 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="unit" required>
                                            ...
                                            <option value="Anna">Anna / VK</option>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <form action="cetak_laporan2.php" target="_blank" method="POST">
                        ...
                        <div class="card-body">
                        <form action="dirrawat.php" method="POST">
                            <?php
                            include 'koneksi/koneksi.php';
                            $data1=mysqli_query($koneksi, "select count(jenis_barang) from dirrawat where unit='".$_POST['unit']."' and jenis_barang='".$_POST['jenis_barang']."'");
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="unit" > 
                                        <option>--Pilih--</option>
                                        <option value ="Maria" <?php if($_POST['unit']=="Maria"){ echo"selected";} ?>>Maria</option>
                                        <option value ="Anna" <?php if($_POST['unit']=="Anna"){ echo"selected";} ?>>Anna</option>
                                        <option value ="Theresia" <?php if($_POST['unit']=="Theresia"){ echo"selected";} ?>>Theresia</option>
                                        <option value ="Yoseph" <?php if($_POST['unit']=="Yoseph"){ echo"selected";} ?>>Yoseph</option>
                                        <option value ="Pastoral Care" <?php if($_POST['unit']=="Pastoral Care"){ echo"selected";} ?>>Pastoral Care</option>
                                    </select>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" cellspacing="0">
                                    ...
                                    if (($_POST['unit']!="")&&($_POST['jenis_barang']!="")) {
                                        ...
                                        $data=mysqli_query($koneksi,"select * from dirrawat where unit = '$unit' and jenis_barang = '$jenis_barang'");
                                    }else{
                                        $data=mysqli_query($koneksi,"select * from dirrawat order by ID desc");
                                    }
                                    while($isi=mysqli_fetch_array($data)){
                                        ...
                                        <tr>
                                            ...
                                            <form action="koneksi/tambah2.php"method="POST">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                            ...
                                            ?>
                                            <td >
                                                <a href="editrawat.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-primary"  style="float:left"><i class="fa fa-file"></i></a> 
                                                <a href="koneksi/hapusrawat.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-danger" style="float:right"><i class="fa fa-eraser"></i></a>
                                                <br>
                                                <br>
                                                <a href="cetak_rawat.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-warning"  style="float:left"><i class="fa fa-print"></i></a>
