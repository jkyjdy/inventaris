            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- ------------------------ MEMASUKKAN JUDUL --------------------------------- -->
                        <h1 class="h3 mb-0 text-gray-800">Direktorat Keuangan</h1>
                    </div>
                    ...
                    <div class="card show mb-4">
                        <div class="card-header bg-primary text-white">
                            ...
                            <div class="card-body" style="background:Slate Blue">
                                <form action="koneksi/tambahdirkeuangan.php" method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                        No Urut
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="unit" required>
                                            ...
                                            <option value="Akuntansi & Piutang">Akuntansi & Piutang</option>
                                            <option value="Keuangan">Keuangan</option>
                                            <option value="Billing & Penerimaan">Billing & Penerimaan</option>
                                            <option value="Pengeluaran">Pengeluaran</option>
                                            <option value="Asuransi Center">Asuransi Center</option>
                                            <option value="Logistik">Logisik</option>
                                        <select>
                                    </div>
                                    <div class="col-md-4">
                                        Jenis Barang 
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <form action="cetak_laporan4.php" target="_blank" method="POST">
                        ...
                        <div class="card-body">
                        <form action="dir_keuangan.php" method="POST">
                            <?php
                            include 'koneksi/koneksi.php';
                            $data1=mysqli_query($koneksi, "select count(jenis_barang) from dir_keuangan where unit='".$_POST['unit']."' and jenis_barang='".$_POST['jenis_barang']."'");
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="unit"> 
                                        <option>--Pilih--</option>
                                        <option value ="Akuntansi & Piutang" <?php if($_POST['unit']=="Akuntansi & Piutang"){ echo"selected";} ?>>Akuntansi & Piutang</option>
                                        <option value ="Keuangan" <?php if($_POST['unit']=="Keuangan"){ echo"selected";} ?>>Keuangan</option>
                                        <option value ="Billing & Penerimaan" <?php if($_POST['unit']=="Billing & Penerimaan"){ echo"selected";} ?>>Billing & Penerimaan</option>
                                        <option value ="Pengeluaran" <?php if($_POST['unit']=="Pengeluaran"){ echo"selected";} ?>>Pengeluaran</option>
                                        <option value ="Asuransi Center" <?php if($_POST['unit']=="Asuransi Center"){ echo"selected";} ?>>Asuransi Center</option>
                                        <option value ="Logistik" <?php if($_POST['unit']=="Logistik"){ echo"selected";} ?>>Logistik</option>
                                ...
                                <table class="table table-bordered" id="dataTable" cellspacing="0">
                                    <thead> 
                                        <tr>
                                            ...
                                            <th>Harga</th>
                                            <?php
                                                if (($_SESSION['role']=="administrator")  or ($_SESSION['role']=="direktorat keuangan")){
                                            ?>
                                    ...
                                    if (($_POST['unit']!="")&&($_POST['jenis_barang']!="")) {
                                        ...
                                        $data=mysqli_query($koneksi,"select * from dir_keuangan where unit = '$unit' and jenis_barang = '$jenis_barang'");
                                    }else{
                                        $data=mysqli_query($koneksi,"select * from dir_keuangan order by ID desc");
                                    }
                                    while($isi=mysqli_fetch_array($data)){
                                        ...
                                        <tr>
                                            ...
                                            <form action="koneksi/tambah4.php"method="POST">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                            ...
                                            <?php
                                                ...
                                                ?>
                                            <td>
                                                <a href="editkeuangan.php?ID=<?php echo $isi['ID']; ?>" class="btn btn-primary" style="float:left"><i class="fa fa-file"></i></a>
                                                <a href="koneksi/hapuskeuangan.php?ID=<?php echo $isi['ID']; ?>" class="btn btn-danger" style="float:right"><i class="fa fa-eraser"></i></a>
                                                <br>
                                                <br>
                                                <a href="cetak_keuangan.php?ID=<?php echo $isi['ID']; ?>"class="btn btn-warning"  style="float:left"><i class="fa fa-print"></i></a>
